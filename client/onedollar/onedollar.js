...
_findBestMatch = function (candidate, template) {
  let centroid, f1, f2, lt, rt, x1, x2
  rt = ANGLE
  lt = -ANGLE
...
__resample = function (points) {
  let distance, idx, point, prev, resampled, seperator, space, x, y
...
__scaleToSquare = function (points) {
  let deltaX, deltaY, i, len, maxX, maxY, minX, minY, offset, point
  minX = minY = +Infinity
  maxX = maxY = -Infinity
...
___rotate = function (points, radians, pivot) {
  let cos, deltaX, deltaY, i, idx, len, neew, point, sin
